...
using VerticalSliceProject.Shared.Errors.Exceptions;
using VerticalSliceProject.Shared.Errors.Models;

namespace VerticalSliceProject.Shared.Errors;
...
/// (<see cref="AppMessageException"/>, <see cref="AppValidationException"/>,
/// <see cref="DomainException"/>) map to 4xx with meaningful detail; everything else gets a
/// generic 500 with no internal info leaked to the caller — the stack trace lives in the log
/// via <c>logger.LogError</c>.
/// </summary>
